...
export const STRING_VALIDATOR_NUMBER_AND_MESSAGE_REGEX =
  /.(?<validator>min|max|length)\((?<number>[\d]+)([,][ ]?)?(?<message>[{][ ]?message:[ ]?['"][\w\W\p{Script=Latin}\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han}\p{M}ʼ。、ー「」・：（）※ﾞﾟ　]+['"][ ]?[}])?\)/u;

export const STRING_VALIDATOR_MESSAGE_REGEX =
  /.(?<validator>email|url|emoji|uuid|cuid|cuid2|ulid|ip|toLowerCase|toUpperCase|trim|datetime|noDefault)(\((?<message>[{][ ]?message:[ ]?['"][\w\W\p{Script=Latin}\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han}\p{M}ʼ。、ー「」・：（）※ﾞﾟ　]+['"][ ]?[}])?\))/u;

export const STRING_VALIDATOR_REGEX = /.(regex)(\((?<message>.*)\))/;

export const STRING_VALIDATOR_STRING_AND_MESSAGE_REGEX =
  /.(?<validator>startsWith|endsWith|includes)\((?<string>['"][\w\W\p{Script=Latin}\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han}\p{M}ʼ。、ー「」・：（）※ﾞﾟ　]+['"])([,][ ]?)?(?<message>[{][ ]?message:[ ]?['"][\w\W\p{Script=Latin}\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han}\p{M}ʼ。、ー「」・：（）※ﾞﾟ　]+['"][ ]?[}])?\)/u;

// NUMBER
// ----------------------------------------
export const NUMBER_VALIDATOR_NUMBER_AND_MESSAGE_REGEX =
  /.(?<validator>min|max|gt|gte|lt|lte|multipleOf|step)\((?<number>[-\d.]+)([,][ ]?)?(?<message>[{][ ]?message:[ ]?['"][\w\W\p{Script=Latin}\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han}\p{M}ʼ。、ー「」・：（）※ﾞﾟ　]+['"][ ]?[}])?\)/u;

export const NUMBER_VALIDATOR_MESSAGE_REGEX =
  /.(?<validator>int|positive|nonnegative|negative|nonpositive|finite|noDefault)(\((?<message>[{][ ]?message:[ ]?['"][\w\W\p{Script=Latin}\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han}\p{M}ʼ。、ー「」・：（）※ﾞﾟ　]+['"][ ]?[}])?\))/u;

// DATE
// ----------------------------------------
export const DATE_VALIDATOR_NUMBER_AND_MESSAGE_REGEX =
  /.(?<validator>min|max)(\()(?<date>(new Date\((['"()\w.-]+)?\)))([,][ ]?)?(?<message>[{][ ]?message:[ ]?['"][\w\W\p{Script=Latin}\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han}\p{M}ʼ。、ー「」・：（）※ﾞﾟ　]+['"][ ]?[}])?\)/u;

// BIGINT
// ----------------------------------------
export const BIGINT_VALIDATOR_NUMBER_AND_MESSAGE_REGEX =
  /.(?<validator>gt|gte|lt|lte|multipleOf)\((?<number>[\w]+)([,][ ]?)?(?<message>[{][ ]?message:[ ]?['"][\w\W\p{Script=Latin}\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han}\p{M}ʼ。、ー「」・：（）※ﾞﾟ　]+['"][ ]?[}])?\)/u;

export const BIGINT_VALIDATOR_MESSAGE_REGEX =
  /.(?<validator>positive|nonnegative|negative|nonpositive|array)(\((?<message>[{][ ]?message:[ ]?['"][\w\W\p{Script=Latin}\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han}\p{M}ʼ。、ー「」・：（）※ﾞﾟ　]+['"][ ]?[}])?\))/u;

// CUSTOM
// ----------------------------------------
export const CUSTOM_VALIDATOR_MESSAGE_REGEX =
  /(?<validator>use|array|omit)(\()(?<pattern>[\w\p{Script=Latin}\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han}\p{M}ʼ (),.'"。、ー「」・：（）※ﾞﾟ　:+\-*#!§$%&/{}[\]=?~><°^|]+)\)/u;
...
export const ARRAY_VALIDATOR_MESSAGE_REGEX =
  /(?<validator>array)(\((?<pattern>[\w\p{Script=Latin}\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han}\p{M}ʼ (),.'"。、ー「」・：（）※ﾞﾟ　:+\-*#!§$%&/{}[\]=?~><°^]+)\))/u;
