...
exports.VALIDATOR_CUSTOM_ERROR_REGEX = /(\()(?<object>\{(?<messages>[\w\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han} (),'"。、ー「」・：（）※ﾞﾟ　:+\-*#!§$%&/{}[\]=?~><°^]+)\})(\))/u;
exports.VALIDATOR_CUSTOM_ERROR_MESSAGE_REGEX = /[ ]?"[\w\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Han} (),.'。、ー「」・：（）※ﾞﾟ　:+\-*#!§$%&/{}[\]=?~><°^]+"[,]?[ ]?/gu;
