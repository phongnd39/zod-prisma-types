...
exports.ExtendedDMMFModel = exports.IMPORT_STATEMENT_REGEX = exports.IMPORT_STATEMENT_REGEX_PATTERN = void 0;
...
class ExtendedDMMFModel extends formattedNames_1.FormattedNames {
    ...
    _extractZodDirectives() {
        ...
        if (!this.documentation)
            return;
        const importStatements = (_a = this.documentation) === null || _a === void 0 ? void 0 : _a.match(exports.IMPORT_STATEMENT_REGEX_PATTERN);
        if (!importStatements) {
            return {
                customImports: [],
